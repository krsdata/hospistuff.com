...
function shopme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'             => 'http://velikorodnov.com/wordpress/sample-data/shopme/pluginus/shopme-content-types.zip',
			'required'           => false,
			'version'            => '1.0.4',
			'force_activation'   => false,
			'force_deactivation' => false
		...
		array(
			...
			'source'             => 'http://velikorodnov.com/wordpress/sample-data/shopme/pluginus/indeed-smart-popup.zip',
			'required'           => false,
			'version'            => '4.6',
			'force_activation'   => false,
			'force_deactivation' => false
		...
		array(
			'name'               => 'LayerSlider WP',
			'slug'               => 'LayerSlider',
			'source'             => 'http://velikorodnov.com/wordpress/sample-data/shopme/pluginus/LayerSlider.zip',
			'required'           => false,
			'version'            => '6.0.5',
			'force_activation'   => false,
			'force_deactivation' => false
		...
		array(
			...
			'slug'               => 'revslider',
			'source'             => 'http://velikorodnov.com/wordpress/sample-data/shopme/pluginus/revslider.zip',
			'required'           => false,
			'version'            => '5.2.6',
			'force_activation'   => false,
			'force_deactivation' => false
