...
wp_enqueue_script( SHOPME_PREFIX . 'wc-price-slider-mod' );
...
echo '<form method="get" action="' . esc_attr($form_action) . '">
		<div class="price_slider_wrapper">
			<div class="price_label clearfix" style="display:none;">
				<span>' . esc_html__('Range', 'shopme') . ': </span><span class="from"></span> - <span class="to"></span>
			</div>
			<div class="price_slider" style="display:none;"></div>
			<div class="price_slider_amount">
				<input type="text" id="min_price" name="min_price" value="' . esc_attr($min_price) . '" data-min="' . esc_attr(apply_filters('woocommerce_price_filter_widget_amount', $min)) . '" placeholder="' . esc_html__('Min price', 'shopme') . '" />
				<input type="text" id="max_price" name="max_price" value="' . esc_attr($max_price) . '" data-max="' . esc_attr(apply_filters('woocommerce_price_filter_widget_amount', $max)) . '" placeholder="' . esc_html__('Max price', 'shopme') . '" />
				' . $fields . '
				<div class="clear"></div>
			</div>
		</div>
