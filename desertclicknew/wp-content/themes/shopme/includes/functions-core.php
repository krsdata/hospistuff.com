...
if (!function_exists('shopme_body_background')) {
	...
	function shopme_body_background() {
		...
		$color = rwmb_meta('shopme_bg_color', '', $post_id);
		$image = rwmb_meta('shopme_bg_image', '', $post_id);
		...
		$image_repeat     = rwmb_meta('shopme_bg_image_repeat', '', $post_id);
		$image_position   = rwmb_meta('shopme_bg_image_position', '', $post_id);
		$image_attachment = rwmb_meta('shopme_bg_image_attachment', '', $post_id);
