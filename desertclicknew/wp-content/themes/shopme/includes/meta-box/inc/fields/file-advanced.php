...
if ( ! class_exists( 'RWMB_File_Advanced_Field' ) )
{
	class RWMB_File_Advanced_Field extends RWMB_File_Field
	{
		...
		static function admin_enqueue_scripts()
		{
			...
			wp_enqueue_media();
			wp_enqueue_script( SHOPME_PREFIX . 'rwmb-file-advanced', RWMB_JS_URL . 'file-advanced.js', array( 'jquery', 'underscore' ), RWMB_VER, true );
			wp_localize_script( SHOPME_PREFIX . 'rwmb-file-advanced', 'rwmbFileAdvanced', array(
				'frameTitle' => esc_html__( 'Select Files', 'shopme' ),
			) );
		}
		...
		{
			$i18n_title  = apply_filters( 'rwmb_file_advanced_select_string', _x( 'Select or Upload Files', 'file upload', 'shopme' ), $field );
