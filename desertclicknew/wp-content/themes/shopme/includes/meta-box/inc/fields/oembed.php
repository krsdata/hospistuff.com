...
if ( ! class_exists( 'RWMB_OEmbed_Field' ) )
{
	class RWMB_OEmbed_Field extends RWMB_URL_Field
	{
		...
		{
			wp_enqueue_style( SHOPME_PREFIX . 'rwmb-oembed', RWMB_CSS_URL . 'oembed.css' );
			wp_enqueue_script( SHOPME_PREFIX . 'rwmb-oembed', RWMB_JS_URL . 'oembed.js', array(), RWMB_VER, true );
		}
		...
		static function get_embed( $url )
		{
			...
			return $embed ? $embed : esc_html__( 'Embed HTML not available.', 'shopme' );
		}
