...
<div class="share-links-wrapper v_centered">
	...
	<div class="share-links">
		...
		<?php if (shopme_custom_get_option('share-product-facebook')): ?>
			<a href="http://www.facebook.com/sharer.php?m2w&amp;s=100&amp;p&#091;url&#093;=<?php echo $permalink ?>&amp;p&#091;images&#093;&#091;0&#093;=<?php echo $image ?>&amp;p&#091;title&#093;=<?php echo $title ?>" <?php echo $extra_attr ?> title="<?php esc_html_e('Facebook', 'shopme') ?>" class="share-facebook share-link"><?php esc_html_e('Facebook', 'shopme') ?></a>
		<?php endif; ?>
