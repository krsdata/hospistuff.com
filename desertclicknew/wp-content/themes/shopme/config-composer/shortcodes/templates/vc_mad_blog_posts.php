					...
					<?php foreach ( $entries->posts as $entry ):
						...
						<li class="<?php echo implode($classes) ?>"><article <?php post_class($post_class, $id) ?>>
							...
							<div class="post-content">
								...
								<?php if ($type == 'type-2'): ?>
									<h5 class="entry_title"><a href="<?php echo esc_url($link) ?>"><b><?php echo esc_html($title) ?></b></a></h5>
								<?php else: ?>
									<h4 class="entry_title"><a href="<?php echo esc_url($link) ?>"><?php echo esc_html($title) ?></a></h4>
								<?php endif; ?>
