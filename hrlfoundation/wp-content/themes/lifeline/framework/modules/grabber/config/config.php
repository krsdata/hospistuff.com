...
$api_settings = ''; //&$GLOBALS['_webnukes']->get_settings('sub_APIs');
...
$options['yt_playlist'] = array(
	'regex' => '/[A-Za-z0-9_-]+$/',
	'link' => 'http://gdata.youtube.com/feeds/api/playlists/{id}?v=2&alt=jsonc&max-results=10',
	'type' => '/(?:youtube(?:-nocookie)?\.com\/playlist\?list=[A-Za-z0-9_-]+)/',
	'source' => 'youtube',
);
$options['yt_channel'] = array(
	'regex' => '/[A-Za-z0-9_-]+$/',
	'link' => 'http://gdata.youtube.com/feeds/api/users/{id}/uploads?v=2&alt=jsonc&max-results=10',
...
if ( $ustream_api = sh_set( $api_settings, 'ustream_api_key' ) ) {
...
if ( $sound_cloud_key = sh_set( $api_settings, 'soundcloud_api_key' ) ) {
	...
	$options['sc_tracks'] = array(
		'regex' => '/[a-zA-Z0-9_-]+$/',
		'link' => 'https://api.soundcloud.com/tracks.json?q={id}&consumer_key=' . $sound_cloud_key,
...
$data['soundcloud'] = array( 'source' => 'soundcloud', 'id' => 'id', 'thumb' => '', 'title' => 'title', 'desc' => 'description', 'duration' => 'duration', 'views' => 'playback_count', 'author' => 'user_id', 'rating' => 'favoritings_count', 'tags' => 'tag_list', 'hd' => false );
