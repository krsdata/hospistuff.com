...
class SH_Options_color_gradient extends SH_Options {
...
//function
	...
	function enqueue() {
		...
		wp_enqueue_script(
				'nhp-opts-field-color-js', SH_Options_URL . 'fields/color/field_color.js', array( 'jquery', 'farbtastic' ), time(), true
		);
	}
