...
class SH_Options_multi_group extends SH_Options {
...
//function
	...
	function render() {
		...
		//printr($this->field);
		echo '<ul id="' . $this->field['id'] . '-ul" class="multigroup">';
...
//function
	...
	function enqueue() {
		...
		wp_enqueue_script(
				'nhp-opts-field-multi-group-js', SH_FRW_URL . 'theme_options/fields/multi_group/field_multi_group.js', array( 'jquery' ), time(), true
		);
	}
