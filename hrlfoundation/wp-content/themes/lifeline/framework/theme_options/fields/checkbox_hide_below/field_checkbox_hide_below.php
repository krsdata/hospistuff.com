...
class SH_Options_checkbox_hide_below extends SH_Options {
...
//function
	...
	function enqueue() {
		...
		wp_enqueue_script(
				'nhp-opts-checkbox-hide-below-js', SH_Options_URL . 'fields/checkbox_hide_below/field_checkbox_hide_below.js', array( 'jquery' ), time(), true
		);
	}
